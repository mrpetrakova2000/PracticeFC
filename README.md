...
Опишите требования, связанные с любыми функциями связи, требуемыми этим продуктом, включая электронную почту, веб-браузер, протоколы связи с сетевым сервером, электронные формы и так далее. Определите любое соответствующее форматирование сообщения. Определите любые стандарты связи, которые будут использоваться, такие как FTP или HTTP. Укажите любые проблемы безопасности связи или шифрования, скорости передачи данных и механизмы синхронизации.
## Особенности системы
...
На самом деле не говорите “Системная функция 1”. Укажите название функции всего в нескольких словах.
#### 4.1.1 Описание и приоритет
Предоставьте краткое описание функции и укажите, имеет ли она высокий, средний или низкий приоритет. Вы также можете включить конкретные оценки приоритетных компонентов, такие как выгода, штраф, стоимость и риск (каждый из них оценивается по относительной шкале от низкого значения 1 до высокого значения 9).
#### 4.1.2 Причинно-следственные связи, алгоритмы
Перечисляют последовательности действий пользователя и системных ответов, которые стимулируют поведение, определенное для этой функции. Они будут соответствовать элементам диалогового окна, связанным с вариантами использования.
#### 4.1.3 Функциональные требования
Перечислите подробные функциональные требования, связанные с этой функцией. Это программные возможности, которые должны присутствовать, чтобы пользователь мог выполнять услуги, предоставляемые функцией, или выполнять вариант использования. Укажите, как продукт должен реагировать на ожидаемые условия ошибки или неверные входные данные. Требования должны быть краткими, полными, однозначными, поддающимися проверке и необходимыми. Используйте “TBD” (to be determined) в качестве заполнителя, чтобы указать, когда необходимая информация еще недоступна.

Каждое требование должно быть однозначно идентифицировано порядковым номером или каким-либо значимым тегом.
